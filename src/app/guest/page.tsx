  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="relative bg-gradient-to-br from-blue-600 via-purple-700 to-indigo-800 text-white min-h-screen flex items-center overflow-hidden">
        {/* Enhanced Abstract Wavy Lines with multiple layers */}
      ...
      <div className="py-24 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden opacity-0 translate-y-8 transition-all duration-1000 ease-out -mt-8" data-fade="up">
        <div className="container mx-auto px-4 relative z-10">
          {/* Section header */}
          <div className="text-center mb-20 opacity-0 translate-y-8 transition-all duration-1000 ease-out" data-fade="up">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-20">
            {/* Card 1 */}
            <div className="group bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl border border-gray-100 relative overflow-hidden opacity-0 translate-y-8 ease-out" data-fade="up">
          ...
          {/* CTA Section */}
          <div className="text-center opacity-0 translate-y-8 transition-all duration-1000 ease-out" data-fade="up">

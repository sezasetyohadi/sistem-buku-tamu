...
export default function ClientLayout({ children, className }: ClientLayoutProps) {
  const [sidebarOpen, setSidebarOpen] = React.useState(true); // Default terbuka di desktop
      ...
      <div className="h-screen flex bg-gray-50 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="flex-shrink-0 flex h-16 bg-white shadow-sm border-b border-gray-200 z-10">
            ...
            <button
              type="button"
              className="hidden md:flex px-4 border-r border-gray-200 text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 transition-colors duration-200 items-center"
              onClick={() => setSidebarOpen(!sidebarOpen)}
            >
